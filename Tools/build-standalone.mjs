...
//
// Usage:  node Tools/build-standalone.mjs   →   dist/Ordforeren.html
...
const JS_MODULES = ["state.js", "engine.js", "clock.js", "rating.js", "auth.js", "bots.js", "fakepool.js", "haptics.js", "audio.js", "themes.js", "net.js", "lottie.js", "fixtures.js", "ui.js"];
...
`;
  ...
  await writeFile(p("dist/Ordforeren.html"), html, "utf8");
  const bytes = Buffer.byteLength(html);
  const kb = (bytes / 1024).toFixed(0);
  console.log(`dist/Ordforeren.html  (${kb} KB)  · ${cardCount} cards · ${LOTTIE.length} Lottie · self-contained`);
...
`;
  await writeFile(p("dist/Ordforeren.artifact.html"), artifact, "utf8");
  console.log(`dist/Ordforeren.artifact.html  (${(Buffer.byteLength(artifact) / 1024).toFixed(0)} KB)  · for claude.ai Artifact`);
}
