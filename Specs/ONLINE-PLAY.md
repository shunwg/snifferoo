...
> **STATUS ENDRET 2026-07-25.** PRD **§2.1** flyttet nett-spill inn i scope — men **kun for nettleser-bygget** (`Lab/`, `dist/Ordforeren.html`, GitHub Pages). iOS-appen i `Sources/` er urørt: fortsatt kun lokal MultipeerConnectivity, fortsatt «Data Not Collected».
>
