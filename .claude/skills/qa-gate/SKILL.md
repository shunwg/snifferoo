---
name: qa-gate
description: Unified validator battery for Ordføreren. Use before any commit, when the user says "qa", "gate", "check everything", "is this shippable", or as the game-director QA phase. Pass --ship for release gating.
---
