...
description: "REFERENCE ONLY — Unity and Unreal Engine patterns (C#/C++, ECS, colliders, object pooling, lag compensation, GPU profiling). Ordføreren uses none of these: no game engine, no physics engine, no WebGL. Do NOT load for Ordføreren work — use the game-feel skill instead. Read this only when the user explicitly asks about Unity, Unreal, ECS, or engine-side optimisation."
license: MIT
---
