...
description: "REFERENCE ONLY — HLSL/CG and GLSL shader authoring for Unity, Unreal, Godot, OpenGL, DirectX and Vulkan. Ordføreren has no shader stage: the Lab is DOM + CSS and iOS is SwiftUI. Do NOT load for Ordføreren work — CSS filters, masks and blend modes are not shaders. Read this only when the user explicitly asks about HLSL, GLSL, or engine rendering pipelines."
---
