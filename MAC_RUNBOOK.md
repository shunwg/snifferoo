...
1. App Store Connect: create the app record (bundle id from project.yml, name **Ordføreren**, primary language nb).
...
- [ ] **Trademark search evidence**: 30 min on Patentstyret + EUIPO for "Ordføreren" — save PDFs of the search results with the release notes (PRD §13)
