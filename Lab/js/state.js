...
export const STR = {
  nb: {
    ...
    partyName: "Hver sin telefon", partySub: "Motspillerne er roboter. Du starter som ordstyrer.",
    ...
    gmIs: (n) => `${n} er ordstyrer`, youAreGm: "Du er ordstyrer", tagline: "Les rommet.", roundN: (r) => `Runde ${r}`,
    gmHint: "Bare ordstyreren ser dette skjermbildet.",
    ...
    gmComposing: (n) => `${n} skriver falske svar`, shuffling: "Ordstyreren blander kortene…",
    ...
    you: "deg", gmDecoy: "ordstyrerens falske svar", gmSteal: "Ingen fant sannheten. Ordstyreren tar +2.",
    doubleHit: (n) => `${n} skrev sannheten uten å vite det. +3`, toBoard: "Til brettet!",
    board: "Brettet", boardSub: (t) => `Først til ${t}. Sjekkes når alle har vært ordstyrer.`,
    nextRound: "Neste runde", winner: (n) => `${n} vant!`, shared: "Delt seier!",
    restOfYou: "Resten av dere: godt forsøk.", topBacking: (n) => `Størst oppslutning: ${n}. Rommet trodde på deg.`,
    playAgain: "Spill igjen", pts: "p",
    rules: "+2 riktig svar · +1 oppslutning per stemme på ditt forslag · +2 til ordstyreren hvis ingen fant fasiten",
    omkamp: "Omkamp!", omkampSub: (ns) => `${ns} står likt forbi mål. Én ekstra runde, og alle stemmer.`,
    homePitch: "Et bløffespill om å vinne rommets oppslutning.",
    homeNewGame: "Nytt spill", homeHowTo: "Slik spiller du", homeAbout: "Om",
    rulesTitle: "Slik spiller du", rulesSub: "Én runde på 30 sekunder",
    rulesStep1t: "Ordstyreren trekker", rulesStep1b: "Ett obskurt ord. Bare ordstyreren får se hva det betyr.",
    rulesStep2t: "Alle andre dikter", rulesStep2b: "Skriv en forklaring så troverdig at den kunne stått i ordboka.",
    rulesStep3t: "Ordstyreren åpner avstemningen", rulesStep3b: "Alle svarene stokkes, og hvert av dem får en bokstav.",
    rulesStep4t: "Alle stemmer", rulesStep4b: "Finn den ekte betydningen. Ditt eget svar er skjult for deg.",
    rulesStep5t: "Avsløringen", rulesStep5b: "Forslagene avsløres. Oppslutningen din vokser ett hakk for hver som trodde på deg.",
    rulesStep6t: "Kappløpet", rulesStep6b: "Poeng flytter brikken din mot mål. Først forbi vinner.",
    rulesBacking: "Én stemme = ett hakk oppslutning. Å ha rett er valgfritt.",
    ...
    aboutBlurb: "Ordføreren er et sosialt bløffespill om å vinne rommets oppslutning. Én spiller kjenner fasiten. Alle andre skriver en troverdig, men oppdiktet forklaring. Svarene vises anonymt, før alle stemmer på det de tror er riktig. Hver stemme på svaret ditt gir oppslutning. Du vinner ikke nødvendigvis ved å ha rett, men ved å være mest overbevisende, og ved å lese rommet godt nok til å vite hva de andre vil tro på. Den som har mest oppslutning til slutt, blir Ordføreren.",
    ...
    aboutPrivacy: "Ingen server ser selve spillet. Kort, løgner og stemmer går rett mellom telefonene. Spiller du på én telefon, ligger profilen din (navn, rating og oppslutning) bare i denne nettleseren. Logger du inn med Google eller Apple, lagrer vi navn, bilde og rating hos Supabase. Du kan slette alt når du vil.",
    homeProfile: "Profilen din",
    profileTitle: "Profilen din", profileGames: "Spill", profileWins: "Seire",
    profileBacking: "Oppslutning samlet", profileLast: "Siste spill",
    ...
    friendsHostGo: "Lag rom",
    friendsJoinTitle: "Bli med i et rom",
    friendsJoinSub: "Skriv koden du har fått.",
  ...
  en: {
    // NOT a translation of "Ordføreren" — a sibling pun that does the same work.
    // Ordfører decomposes to ord + fører, "word-leader", and is everyday Norwegian
    // for a mayor: a local, elected, slightly self-important office. English has no
    // such compound, so Wor(l)d-Leader builds one — word and world in the same
    // breath — and scales the satire from a town hall to an international assembly,
    // which is where the English copy sets the game. Shun's, and better than the
    // "The Speaker" this briefly shipped as, which was accurate and inert.
    title: "Wor(l)d-Leader", demo: "lab", pickLang: "Choose language",
    mode: "How do you want to play?", hotseatName: "One phone", hotseatSub: "One phone goes round the table.",
    partyName: "A phone each", partySub: "Your opponents are bots. You start as the Chair.",
    ...
    gmIs: (n) => `${n} is the Chair`, youAreGm: "You are the Chair", tagline: "Read the chamber.", roundN: (r) => `Round ${r}`,
    gmHint: "Only the the Chair sees this screen.",
    ...
    gmComposing: (n) => `${n} is composing decoys`, shuffling: "The the Chair shuffles the cards…",
    ...
    you: "you", gmDecoy: "the the Chair's false answer", gmSteal: "Nobody found the truth. The the Chair takes +2.",
    doubleHit: (n) => `${n} simply wrote the truth. +3!`, toBoard: "To the board!",
    board: "The board", boardSub: (t) => `First to ${t}. Checked when everyone has been the Chair.`,
    nextRound: "Next round", winner: (n) => `${n} wins!`, shared: "Shared victory!",
    restOfYou: "The rest of you: nice try.", topBacking: (n) => `Most backing: ${n}. The chamber believed you.`,
    playAgain: "Play again", pts: "p",
    rules: "+2 correct vote · +1 backing per vote your motion gets · +2 to the Chair if nobody finds the truth",
    omkamp: "Sudden death!", omkampSub: (ns) => `${ns} are tied past the line. One extra round, and everyone votes.`,
    homePitch: "A political party game about winning the room's backing.",
    homeNewGame: "New game", homeHowTo: "How to play", homeAbout: "About",
    rulesTitle: "How to play", rulesSub: "One round in 30 seconds",
    rulesStep1t: "The the Chair draws", rulesStep1b: "One obscure word. Only the the Chair sees what it means.",
    ...
    rulesStep5t: "The reveal", rulesStep5b: "The motions are unmasked. Your backing grows a notch for every delegate who believed you.",
    rulesStep6t: "The race", rulesStep6b: "Points move your pawn toward the goal. First past the line wins.",
    rulesBacking: "One vote = one notch of backing. Being right is optional.",
    ...
    aboutBlurb: "Wor(l)d-Leader is a political party game set in a playful international assembly. One delegate knows the real answer. Everyone else writes a believable alternative, then the room votes anonymously. Your job is not simply to sound smart, it is to read the chamber, understand what people are ready to believe, and build a coalition behind your version. Each vote gives you backing. Facts matter, but support matters more. By the end, the delegate with the most backing is elected World-Leader.",
    aboutCredits: "Fonts and audio: Fredoka (OFL), lottie-web (MIT), Kenney (CC0).",
    // Honest, not reassuring — see the nb note above.
    aboutPrivacy: "No server sees the game itself. Cards, lies and votes go straight between the phones. If you play on one phone, your profile (name, rating and backing) lives only in this browser. If you sign in with Google or Apple, we store your name, picture and rating with Supabase. You can delete all of it whenever you like.",
    homeProfile: "Your profile",
    profileTitle: "Your profile", profileGames: "Games", profileWins: "Wins",
    profileBacking: "Backing collected", profileLast: "Recent games",
    ...
    friendsHostGo: "Start room",
    friendsJoinTitle: "Join a room",
    friendsJoinSub: "Type the code you were given.",
