...
export const STR = {
  nb: {
    ...
    joinFailStarted: "Spillet er kommet for langt. Døra sto åpen i tre minutter etter start.",
    joinFailFull: "Rommet er fullt — åtte er maks.",
    joinPlayBots: "Spill mot roboter i stedet",
    lobbyLateWindow: "Døra står åpen i tre minutter etter start — den som kommer sent blir med likevel.",
  ...
  en: {
    ...
    joinFailStarted: "That game's too far along. The door was open for three minutes after the start.",
    joinFailFull: "That room is full — eight is the maximum.",
    joinPlayBots: "Play against bots instead",
    lobbyLateWindow: "The door stays open for three minutes after the start — latecomers still get in.",
