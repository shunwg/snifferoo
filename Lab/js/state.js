...
export const STR = {
  nb: {
    ...
    lobbyLateWindow: "Døra står åpen hele spillet — den som kommer sent blir med likevel.",
    lateJoined: (n) => `${n} kom inn i spillet`,
    lateTookSeat: (n, bot) => `${n} tok over plassen — og poengene — til ${bot}`,
    lateWaiting: (n) => `${n} venter på tur`,
    lateSeated: (n) => `${n} er med fra nå — starter likt med sisteplassen`,
  ...
  en: {
    ...
    lobbyLateWindow: "The door stays open all game — latecomers still get in.",
