...
(`Tools/check-game-feel.mjs`) are *comments* recording which
...
| `Resources/Lottie/rosette_shimmer.json` | generated, original — ours | Ours | Top-backing award glint (loopable 1.6 s; RM poster: rosette with static sparkles) |
